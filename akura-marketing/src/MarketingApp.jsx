  ...
  return (
    <section className="marketing-overview">
      <Card className="marketing-overview-card">
        ...
        <Typography.Text tone="secondary">Pilih modul Marketing dari navigasi untuk mulai mengelola data.</Typography.Text>
...
function MarketingApp({ pathname = window.location.pathname }) {
  ...
  const endsWithAny = (...paths) => paths.some((path) => normalizedPath.endsWith(path))
